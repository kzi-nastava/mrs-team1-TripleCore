...
public class AdminController {
    ...
    @GetMapping("/rides")
    public ResponseEntity<RideHistoryResponse> getAllRides() {
        List<RideHistoryItemResponse> rides = generateMockRides();

        RideHistoryResponse response = new RideHistoryResponse(rides);
